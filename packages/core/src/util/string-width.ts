// Minimal wcwidth-based string width, matching Bun.stringWidth for the
// characters the CLI renders (CJK wide, zero-width, control, and ASCII).
// Adapted from the wcwidth ranges used by common terminal emulators.
...
export function stringWidth(value: string): number {
  ...
  for (const char of value) {
    ...
    if (inRanges(code, ZERO_WIDTH)) continue
