...
const it = testEffect(LayerNode.compile(LayerNode.group([ToolRegistry.node, CrossSpawnSpawner.node, Ripgrep.node]), [[LocationServiceMap.node, testLocationServiceMap]]))
